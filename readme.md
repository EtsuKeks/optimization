...
Видно, что у нас небольшое простаивание потоков в очереди на исполнение (всего с десяток миллисекунд), однако на несглаженном графике видно что бывают сильные всплески - это указывает на периодические блокировки исполнения, такое может приводить к отказу сервера при больших нагрузках. Блокировки эти могут быть связаны с вытеснением из-за долгого выделения памяти, или возможно даже с STW паузами, в любом случае это нехорошо и явно требует фикса после полноценного профилирования.
